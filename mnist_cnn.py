...
def mnist_cnn():
    """
    This function trains a CNN model on the MNIST dataset for handwritten digit classification.
    ...
    parser.add_argument('--weight_decay', type=float, default=1.96e-06, metavar='W',
                        help='weight-decay (default: 1.96e-06)')
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        model, train_loss, accuracies_train, errors_train = train(model, device, train_set, optimizer, criterion, args.batch_size)
